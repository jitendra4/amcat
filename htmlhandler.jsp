...
//STATEMENT
String query = "insert into html values('"+id+"','"+ques+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"')";
    ...
    out.println("<button><a href='html.jsp'>click here</button></a>");
     out.println("</h2>");
    ...
    }else
    {
    	...
    	out.println("<a href='html.jsp'>please try again</a>");
    }
