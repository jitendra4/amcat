...
<hr>                     
 ...
 i++;
                      ...
                      <input  formaction="javaresult.jsp" type="submit" value="submit" style="font-size: 25px; background-color: aqua; border-style: solid; width: 90px; margin-right: 20px; border-radius: 10px; border-color: red;" />
