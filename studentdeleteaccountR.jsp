...
<%
 ...
 String email = request.getParameter("deleteid");
 String pass = request.getParameter("deleteid1");
 ...
 // out.println("<b style='color : blue'><i></i></b>");
  response.sendRedirect("http://localhost:8080/Myproject/studeletedeletehandler.jsp");
 ...
 {
  // show data at client side
 response.sendRedirect("http://localhost:8080/Myproject/studentdeleteaccountExist.jsp");
