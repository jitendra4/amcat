...
String query = "insert into php values('"+id+"','"+ques+"','"+a+"','"+b+"','"+c+"','"+d+"','"+ans+"')";
    ...
    out.println("<button><a href='php.jsp'>click here</button></a>");
     out.println("</h2>");
    ...
    }else
    {
    	...
    	out.println("<a href='php.jsp'>please try again</a>");
    }
